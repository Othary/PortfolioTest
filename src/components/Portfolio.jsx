...
const Portfolio= (autoSlide) => {
  ...
  const onSlidesHoverRight = () => {
    rightArrowRef.current.className = 'z-[100] w-[8vw] sm:w-[3vw] absolute top-[35%] xl:top-[40%] md:top-[42%] sm:top-[44%] right-[1%] sm:-right-[2%] transition ease-in-out hover:scale-[1.15]  scale-[1.15]';
  }
  ...
  useEffect(() =>{
    ...
    leftArrowRef.current.className = 'z-[100] w-[8vw] sm:w-[3vw] absolute top-[35%] xl:top-[40%] md:top-[42%] sm:top-[44%] left-[1%] sm:-left-[2%] transition ease-in-out hover:scale-[1.0]';
    rightArrowRef.current.className = 'z-[100] w-[8vw] sm:w-[3vw] absolute top-[35%] xl:top-[40%] md:top-[42%] sm:top-[44%] right-[1%] sm:-right-[2%] transition ease-in-out hover:scale-[1.0]';
    return () => clearTimeout(); 
  },[slider]);
  ...
  return (
    <div name='gallery'  className='relative z-10 flex items-center justify-center w-full min-h-screen bg-[#0a192f] text-gray-300 overflow-hidden sm:pt-[8vh]'>
      <img ref={leftBgRef} src={slider[1]} className='absolute w-screen  blur-[3px] mix-blend-overlay opacity-0 '  alt="invisible blurred background 1" />
      <img ref={rightBgRef} src={slider[3]} className='absolute w-screen  blur-[3px] mix-blend-overlay opacity-0 '  alt="invisible blurred background 2" />

      <img ref={bgRef} src={slider[2]} className='absolute w-screen  blur-[3px] mix-blend-overlay ' alt="blurred shade" />
      ...
      <div className="z-10 flex flex-col items-center pt-[4vh] max-w-screen">
        ...
        <div name='slider' className='block relative pt-[3vh] sm:pt-[5vh] sm:mb-[5vh]'>
          ...
          <div className='flex items-center w-full pb-[4vh] sm:pb-0   '>
            ...
            {/* CENTER */}
            <div className="max-w-[80vw] sm:max-w-[40vw] xl:max-w-[30vw] z-[10] ">
              <div> 
